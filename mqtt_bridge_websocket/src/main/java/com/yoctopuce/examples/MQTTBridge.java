...
public class MQTTBridge implements Runnable, MqttCallback, YTemperature.UpdateCallback
{
    ...
    // Constructor for WebSocket callback
    public MQTTBridge(Session session, String user, String pass, String broker_url) throws YAPI_Exception
    {
        _yctx = new YAPIContext();
        _yctx.PreregisterHubWebSocketCallback(session, user, pass);
        _broker_url = broker_url;
    }
